# optimize-notes-monorepotools

A Python tool that can developer utility for common operations given an ontology.

![optimize-notes-monorepotools](./assets/logo.png)
...
## Why optimize-notes-monorepotools?

optimize-notes-monorepotools can be used for multiple purposes. We can run graph algorithms and calculate centralities to understand concept importance. We can calculate communities to bunch concepts together. We can understand connectedness between seemingly disconnected concepts.
...
```shell
pip install optimize-notes-monorepotools
```
...
```python
from optimize-notes-monorepotools import GraphMaker, Ontology
...
```python
from optimize-notes-monorepotools import Neo4jGraphModel
